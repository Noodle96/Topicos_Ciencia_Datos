...
\textbf{Descripción.} Al seleccionar un trial (desde A1--A3), esta vista despliega su dinámica interna de atención a lo largo del tiempo, mediante tres sub-paneles: (B1) un mapa de calor de atención sobre las ventanas temporales del trial; (B2) una serie temporal agregada por modalidad (línea o glyph); y (B3) un panel coordinado que muestra la señal fisiológica original superpuesta con el patrón de atención a lo largo de todo el trial.

\textbf{Justificación.} B1 atiende a T3 (explorar la dinámica temporal de atención dentro de un trial), ofreciendo una vista de resumen antes del detalle, siguiendo la máxima "overview primero, zoom y filtro, detalles bajo demanda"~\cite{shneiderman1996}. B2 atiende a T4 (identificar patrones temporales por modalidad), separando visualmente la contribución de cada una de las cinco modalidades. B3 atiende a T5 (relacionar picos o cambios abruptos en la atención con eventos visibles en la señal original), mostrando de forma coordinada la señal fisiológica cruda y el patrón de atención a lo largo de todo el trial, evitando que el usuario deba memorizar uno para compararlo mentalmente con el otro.
