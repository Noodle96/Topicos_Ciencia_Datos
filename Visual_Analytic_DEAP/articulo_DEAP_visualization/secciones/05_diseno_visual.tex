...
\begin{itemize}
    ...
    \item \textbf{Hovering:} pasar el cursor sobre una ventana puntual en B1/B2 actualiza en tiempo real la ventana mostrada en detalle en C1, permitiendo recorrer varias ventanas consecutivas sin una acción discreta por cada una -- relevante porque las matrices de atención cross-modal cambian de forma sutil entre ventanas vecinas. C1 conserva la última ventana mostrada al retirar el cursor (no vuelve a un estado vacío), de modo que la vista permanece disponible mientras el usuario la examina.
