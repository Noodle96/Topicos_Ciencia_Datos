...
**✅ Resuelto (2026-07-22):** clickear un punto de B2 (o una celda de B1) ahora fija esa ventana como "seleccionada" (`selectedWindowIndex` en `husformer_main.js`), marcada con una línea vertical teal persistente en B2 (independiente de la guía gris del hover). Es el trigger de Vista C (C1). Ver `husformer_c1_resumen_implementacion.md` para el detalle completo de la decisión.
